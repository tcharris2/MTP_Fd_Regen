...
ln_heightHarvestNullP <- function(df) {
...
ln_heightHarvest_1P <- function(df) {
...
ln_heightHarvest_2P <- function(df) {
...
ln_heightHarvest_3P <- function(df) {
